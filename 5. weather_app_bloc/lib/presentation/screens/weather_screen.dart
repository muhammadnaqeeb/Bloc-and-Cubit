    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            onPressed: () {
              // when refreash is clicked we have to run API again
              context.read<WeatherBloc>().add(WeatherFetched());
            },
      ...
      body: BlocBuilder<WeatherBloc, WeatherState>(
        builder: (context, state) {
          // make sure this this statement is before loading, if not it will be loading forever
          ...
          // now otherwise it will be a success then\
